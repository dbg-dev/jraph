...
def get_graphs_tuples(
    n_edge, sharded_n_edge, device_graph_idx
) -> tuple[GraphsTuple, ShardedEdgesGraphsTuple]:
    ...
    sharded_edges = np.reshape(graphs.edges, [devices, -1, graphs.edges.shape[-1]])
